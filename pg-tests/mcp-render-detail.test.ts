...
import type { CourseResponse, SectionResponse, InstructorResponse, MeetingResponse } from "../pg/types.ts";

const instructor = (o: Partial<InstructorResponse> = {}): InstructorResponse => ({
  name: "Ada Lovelace",
...
const meeting = (o: Partial<MeetingResponse> = {}): MeetingResponse => ({
  meeting_days: "MWF",
  start_time: "09:55",
  end_time: "10:45",
  meeting_number: 1,
  ...
  room: "1240",
  location: "CS 1240",
  monday_meeting_start: null,
  monday_meeting_end: null,
  tuesday_meeting_start: null,
  tuesday_meeting_end: null,
  wednesday_meeting_start: null,
  wednesday_meeting_end: null,
  thursday_meeting_start: null,
  thursday_meeting_end: null,
  friday_meeting_start: null,
  friday_meeting_end: null,
  ...o,
});

const section = (o: Partial<SectionResponse> = {}): SectionResponse => ({
  section_id: "LEC001",
  section_uuid: "s1",
  status: "OPEN",
  available_seats: 12,
...
const course = (o: Partial<CourseResponse> = {}): CourseResponse => ({
  ...
  grading_basis_description: "Letter grade",
  open_to_first_year: false,
  repeatable_for_credit: false,
  most_recent_gpa: null,
  median_grade: "B",
  a_percent: 25,
  ab_percent: 15,
  b_percent: 35,
